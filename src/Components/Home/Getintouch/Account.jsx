...
function Account() {
  return (
    <div className="grid grid-cols-2 mb-[100px] bg-gradient-to-r from-indigo-50  text-[#5D5A88]">
      <div className="m-[30px] h-[620px]  pl-[150px] pt-[100px]">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex row pt-[50px]">
            <button className="bg-[#5D5A88] pl-12 pr-12 pt-2 pb-2 mr-4   text-white rounded-lg">
              Sign up
            </button>
            <button className="bg-white border pl-12 pr-12 pt-2 pb-2  rounded-lg ">
              Contact us
            </button>
          </div>
        </div>
      ...
      <div className="h-[620px] flex row">
        <div className="w-262 h-244">
          <img
            src="/assets/middle.png"
            alt=".."
            className="absolute pl-[100px] mt-[310px] "></img>
        </div>
        <img
          src="/assets/large.png"
          alt=".."
          className="relative px-[45px] mt-8 "></img>
        <img
          src="/assets/small.png"
          alt=".."
          className="absolute mr-[100px] mt-[300px]"></img>
      </div>
    </div>
  );
}
