    ...
    <AdminLayer>
      <div className="w-full h-[55%] grid grid-cols-2">
        ...
        <div className="w-auto h-auto bg-white m-7 shadow-xl rounded-md p-4">
          <h2 className="text-[#8000FF] font-semibold text-lg">
            Total Members
          </h2>
          <div className="grid grid-cols-2">
            <div>
              ...
              <img
                alt=""
                src="/assets/Admin/trainerWithboard.png"
                className="inline"
              />
              <p className="inline-block font-bold text-5xl text-[#8000FF] mt-4">
                5
              </p>
            </div>
            <div className="">
              ...
              <img
                alt=""
                src="/assets/Admin/studentwithbag.png"
                className="inline"
              />
              <p className="inline-block font-bold text-5xl text-[#8000FF] mt-4">
                100
        ...
        <div className="w-auto h-auto bg-white m-7 shadow-xl rounded-md p-4">
          ...
          <p className="inline font-semibold text-lg">Admin</p>
          <BsArrow90DegDown className="inline -rotate-90" />{" "}
          <p className="inline float-right mr-6">9:30</p>
          <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua.
          </p>
          <hr className="my-2 w-5/6 mx-auto" />
          <p className="inline font-semibold text-lg">Trainer</p>
          <BsArrow90DegDown className="inline -rotate-90" />{" "}
          <p className="inline float-right mr-6">Yesterday</p>
      ...
      <div className="w-full h-[36%] pt-8 px-8">
        <div className="w-full h-[90%] bg-white mx-auto shadow-xl rounded-md p-4">
          ...
          <span className="block px-4 pt-2">
            <p className="inline text-lg text-gray-600">
              Trainer Jack Doe submitted a grade report for Soft Skill training.
            </p>
            <p className="inline float-right mr-6">9:30</p>
          </span>
          <hr className="my-2 w-5/6 mx-auto" />
