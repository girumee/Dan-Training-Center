    ...
    return <div className="col-span-7 h-screen">
            ...
            <div className="flex gap-10">
                <div className="w-3/4 h-9 bg-white rounded-lg mt-5 ml-5 flex border-[#B468FF] border">
                    <input type='search'  className="text-center h-full w-full rounded-lg  bg-white placeholder:text-lg placeholder:text-left placeholder:pl-4" placeholder="search for user, email address..."></input>
